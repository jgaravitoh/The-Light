...
public class CarouselRenderTexture : MonoBehaviour, IEndDragHandler
{
    [Header("Parts Setup")]
    [SerializeField] private List<CarouselEntryRenderTexture> entries = new List<CarouselEntryRenderTexture>();
    ...
    [SerializeField] private RawImage carouselEntryPrefab;
    [SerializeField] private List<GameObject> gameObjectsModels = new List<GameObject>();
    private List<RawImage> _imagesForEntries = new List<RawImage>();
    ...
    private void Start()
    {
        ...
        {
            RawImage carouselEntry = Instantiate(carouselEntryPrefab, contentBoxHorizontal);
            carouselEntry.texture = entry.EntryGraphic;
